                                    ...
                                    <div class="sm:col-span-8 lg:col-span-7">
                                        ...
                                        >
                                            ...
                                            <div className="w-full flex">
                                                <button
                                                    type="submit"
                                                    class="mt-6 flex w-1/3 items-center justify-center rounded-md border border-transparent bg-indigo-600 py-3 px-8 text-base font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                                                    onClick={() =>
                                                        handleAddToCart(
                                                            currentProduct
                                                        )
                                                ...
                                                <button
                                                    type="submit"
                                                    class="mt-6 flex w-1/3 ml-5 items-center justify-center rounded-md border border-transparent bg-indigo-600 py-3 px-8 text-base font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                                                >
                                                    <Link to="/addtocart">
                                                        Continue to cart
                                                    </Link>
