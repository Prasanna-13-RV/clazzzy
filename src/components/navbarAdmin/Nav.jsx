...
const Nav = () => {
    return (
        <>
            <section className="fixed inset-y-0 left-0 bg-white shadow-md max-h-screen w-60">
                <div className="flex flex-col justify-between h-full">
                    <div className="flex-grow">
                        <div className="px-4 py-6 text-center border-b">
                            <h1 className="text-xl font-bold leading-none">
                                <a href="/admin/dashboard" className="text-yellow-700">
                                    CLAZZZY
                                </a>{" "}
                    ...
                    <div className="p-4">
                        ...
                        <span className="font-bold text-sm ml-2">Website</span>
                    </div>
                </div>
            </section>
        </>
